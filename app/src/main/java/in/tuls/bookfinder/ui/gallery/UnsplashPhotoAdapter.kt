...
import `in`.tuls.bookfinder.databinding.ItemUnsplashPhotoBinding
    ...
    inner class PhotoViewHolder(private val binding: ItemUnsplashPhotoBinding) :
        ...
        fun bind(book: UnsplashPhoto) {
            ...
            binding.apply {
                ...
                textViewUserName.text = if (book.volumeInfo.authors.isNullOrEmpty()) "" else book.volumeInfo.authors.joinToString()
            }
        }
    }

    interface OnItemClickListener {
        fun onItemClick(book: UnsplashPhoto)
    }
